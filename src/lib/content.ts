...
export type Project = {
  ...
  evidence: Evidence[]; presentation?: { title: string; src: string; preview: string; pages: number };
};
export type Experience = { id: string; name: string; year?: string; type: string; summary: string; actions: string[] };
...
export const experiences: Experience[] = [
  {id:'doran',name:'도란도란 알고리즘 스터디',year:'2025',type:'STUDY · ORGANIZER',summary:'의지만으로 끝나지 않도록, 함께 공부하는 과정을 설계했습니다.',actions:['10주 알고리즘 커리큘럼 구성','주 2회 설명·문제 리뷰 방식과 노션 운영 구조 설계']},
  {id:'19munpa',name:'19문파 · 공동 학습 공간',year:'2024',type:'STUDY · COLLABORATION',summary:'각자가 배운 것을 설명하고 질문하며 함께 이해하는 학습 공간을 만들었습니다.',actions:['전공 과목별 역할 분담과 노션 자료 정리','매주 발표·질의응답으로 이해도를 점검하고 부족한 부분 보완']},
